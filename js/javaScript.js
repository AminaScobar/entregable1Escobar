...
function qIdiomaHablas () {
   ...
   let idioma = prompt("Bienvenido al cotizador automático del taller automotriz Gonzalez. \nSi hablas español, digita ES. \n\nWelcome to the Gonzalez auto shop automatic quote. \nIf you speak English, type EN.").toLowerCase()
   if (idioma === ingles) {
...
const codigoProductos = ["cam", "cat", "cf", "cb", "no"]
